    ...
    <StyleBox>
      <Container>
        ...
        <ServicesRight>
          ...
          <ButtonSecondary variant="outlined" colorBt="#F23581" >Add New Services</ButtonSecondary>
        </ServicesRight>
      </Container>
      <StyleContent>
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((index) => (
          <StyleSelection key={index}>
            <StyleForm >
              ...
              <SubTitle>Partner with me to reach your target audience quickly and effectively.</SubTitle>
              <StyleChips>
                <Chips label="X Content" variant="outlined" sx={{ color: "#F23581", backgroundColor: "#FFD7F4" }} />
                <Chips label="Research" variant="outlined" sx={{ color: "#3EAABE", backgroundColor: "#EBFCFF" }} color="primary" />
                <Chips label="SocialFi" variant="outlined" sx={{ color: "#F23581", backgroundColor: "#FFD7F4" }} color="secondary" />
                <Chips label="Ethereum" color="secondary" sx={{ color: "#25002D", backgroundColor: "#F6CCFF" }} />
              </StyleChips>
              <Transfer>
