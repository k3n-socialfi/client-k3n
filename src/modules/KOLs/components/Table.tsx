"use client";
import { IconFilter, IconReset, IconVerify, IconStar, IconNFT } from "@/assets/icons";
import { Avatar } from "@mui/material";
import { Chip, TableRow, TableHead, TableContainer, TableCell, TableBody, Table, Paper, Autocomplete, TextField } from "@mui/material";
...
export default function TableTrending(props: ITableTopRankingProps) {
    ...
    return (
        <div>
            <Filter>
                <ItemFilters><IconFilter />Filters by</ItemFilters>
                <Autocomplete
                    size="small"
                    id="grouped-demo"
                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <CustomTableRow>
                            ...
                            <CustomTableCell align="center" sortDirection="asc" padding="none">
                                Price
                            </CustomTableCell>
                            <CustomTableCell align="center">
                                Reviews
                    ...
                    <TableBody>
                        {DATA_TABLE.map((row: any, index) => (
                            ...
                            >
                                ...
                                <CustomTableCell align="center">
                                    <Cell><IconVerify />{row.badge}</Cell>
                                </CustomTableCell>
                                <CustomTableCell align="center">
                                    <Cell>{row.follower}</Cell>
                                </CustomTableCell>
                                <CustomTableCell align="center">
                                    <Cell><IconNFT />{row.price}</Cell>
                                </CustomTableCell>
                                <CustomTableCell align="center">
                                    <Cell><IconStar />{row.review}</Cell>
                                </CustomTableCell>
                                <CustomTableCell align="center">
                                    <Tags>
                                        {row.tags.map((item: string, index: number) => <ItemTags key={index}>{item}</ItemTags>)}
                                    </Tags>
                                </CustomTableCell>
                            </TableRow>
                        ))}
