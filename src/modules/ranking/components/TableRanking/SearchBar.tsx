...
const SearchBar = forwardRef<HTMLInputElement>((props, ref) => {
  ...
  return (
    <div className="searchbar-wrapper">
      <div
        className={
          "px flex h-[56px] items-center justify-between rounded-lg border border-transparent bg-bgray-50 px-4 focus-within:border-success-300 dark:bg-darkblack-500"
        }
      >
